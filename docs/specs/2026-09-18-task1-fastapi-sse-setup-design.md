...
- **Cancellation**: saat client menutup koneksi, Starlette membatalkan generator kita → blok `finally` membatalkan task producer sehingga sumber ikut berhenti. Nanti inilah yang mencegah kita membayar token LLM yang sudah ditinggalkan user. *(Perilaku persisnya diverifikasi di task 6, bukan diasumsikan.)*
