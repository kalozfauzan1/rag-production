...
| Dokumen | Isi | Status |
| --- | --- | --- |
| [specs/2026-09-18-task1-fastapi-sse-setup-design.md](specs/2026-09-18-task1-fastapi-sse-setup-design.md) | Desain task 1: struktur FastAPI, kontrak SSE, pola async, failure mode | disetujui |
